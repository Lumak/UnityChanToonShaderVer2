...
////// Lighting:
                ...
                float node_1242 = (saturate((_Set_HighColorMask_var.g+_Tweak_HighColorMaskLevel))*lerp( (1.0 - step(node_6430,(1.0 - _HighColor_Power))), pow(node_6430,exp2(lerp(11,1,_HighColor_Power))), _Is_SpecularToHighColor ));
                float3 node_2397 = (lerp( _HighColor.rgb, (_HighColor.rgb*Set_LightColor), _Is_LightColor_HighColor )*node_1242);
                float node_7081 = Set_FinalShadowMask;
                float3 Set_HighColor = (lerp( saturate((node_3441-node_1242)), node_3441, _Is_BlendAddToHiColor )+lerp( node_2397, (node_2397*((1.0 - node_7081)+(node_7081*_TweakHighColorOnShadow))), _Is_UseTweakHighColorOnShadow ));
                float3 node_3159 = Set_HighColor;
                float2 node_8669 = Set_UV0;
                float4 _Set_RimLightMask_var = tex2D(_Set_RimLightMask,TRANSFORM_TEX(node_8669, _Set_RimLightMask));
                ...
                float node_7132 = 1.0;
                float node_1745 = 0.0;
                float node_5991 = saturate(lerp( (node_1745 + ( (node_3992 - _RimLight_InsideMask) * (node_7132 - node_1745) ) / (node_7132 - _RimLight_InsideMask)), step(_RimLight_InsideMask,node_3992), _RimLight_FeatherOff ));
                float node_3552 = 0.5*dot(i.normalDir,lightDirection)+0.5;
                float3 _LightDirection_MaskOn_var = lerp( (_Is_LightColor_RimLight_var*node_5991), (_Is_LightColor_RimLight_var*saturate((node_5991-((1.0 - node_3552)+_Tweak_LightDirection_MaskLevel)))), _LightDirection_MaskOn );
                float node_6407 = pow(node_4927,exp2(lerp(3,0,_Ap_RimLight_Power)));
                float3 Set_RimLight = (saturate((_Set_RimLightMask_var.g+_Tweak_RimLightMaskLevel))*lerp( _LightDirection_MaskOn_var, (_LightDirection_MaskOn_var+(lerp( _Ap_RimLightColor.rgb, (_Ap_RimLightColor.rgb*Set_LightColor), _Is_LightColor_Ap_RimLight )*saturate((lerp( (node_1745 + ( (node_6407 - _RimLight_InsideMask) * (node_7132 - node_1745) ) / (node_7132 - _RimLight_InsideMask)), step(_RimLight_InsideMask,node_6407), _Ap_RimLight_FeatherOff )-(saturate(node_3552)+_Tweak_LightDirection_MaskLevel))))), _Add_Antipodean_RimLight ));
